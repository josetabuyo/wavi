# Vendored unmodified from microsoft/OmniParser (util/box_annotator.py),
# https://github.com/microsoft/OmniParser — licensed CC-BY-4.0. See
# wavi/_vendor/omniparser_utils.py for the full licensing note.
